...
export const TOYS_PACK: StarterPack = {
  ...
  requiredAssets: [
    'demo/toys/hero-01.jpg',
    'demo/toys/cat-01.jpg',
    'demo/toys/cat-02.jpg',
    'demo/toys/cat-03.jpg',
    'demo/toys/toy-01.jpg',
    'demo/toys/toy-02.jpg',
    'demo/toys/toy-03.jpg',
    'demo/toys/toy-04.jpg',
    'demo/toys/toy-05.jpg',
    'demo/toys/toy-06.jpg',
    'demo/toys/toy-07.jpg',
    'demo/toys/toy-08.jpg',
  ],
  ...
  products: [
    {
      ...
      base_price: 390,
      is_featured: true,
      images: [IMG('toy-01.jpg'), IMG('toy-02.jpg')],
      sizes: [null],
      colors: ['หมี', 'กระต่าย'],
      stock: 15,
      created_days_ago: 45,
    ...
    },
    {
      ...
      base_price: 690,
      is_featured: true,
      images: [IMG('toy-02.jpg'), IMG('toy-01.jpg')],
      sizes: ['แรกเกิด-1 ปี'],
      colors: [null],
      stock: 8,
  ...
  content: {
    ...
    heroSlides: [
      ...
      },
      {
        ...
        ctaText: 'ช้อปเลย',
        ctaHref: '/products',
        imageUrl: IMG('cat-02.jpg'),
      },
    ],
    categoryBanners: [
      { title: 'ของเล่นเสริมพัฒนาการ', sub: 'เรียนรู้ผ่านการเล่น', imageUrl: IMG('cat-01.jpg'), href: '/products' },
      { title: 'ตุ๊กตา', sub: 'เพื่อนซี้ตัวนุ่มของลูก', imageUrl: IMG('cat-02.jpg'), href: '/products' },
      { title: 'ของใช้แม่และเด็ก', sub: 'ครบทุกอย่างที่แม่ต้องใช้', imageUrl: IMG('cat-03.jpg'), href: '/products' },
    ],
    categoryCircles: [
      { label: 'เสริมพัฒนาการ', imageUrl: IMG('toy-03.jpg'), href: '/products' },
      { label: 'ตุ๊กตา', imageUrl: IMG('toy-01.jpg'), href: '/products' },
      { label: 'เสื้อผ้าเด็ก', imageUrl: IMG('toy-06.jpg'), href: '/products' },
      { label: 'ของใช้เด็ก', imageUrl: IMG('toy-07.jpg'), href: '/products' },
      { label: 'มาใหม่', imageUrl: IMG('toy-05.jpg'), href: '/products' },
      { label: 'ลดราคา', imageUrl: IMG('toy-04.jpg'), href: '/products' },
    ],
    memberBenefits: [
