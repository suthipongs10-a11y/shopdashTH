...
const FEATURES = [
  ...
  {
    icon: 'shield',
    title: 'คิวตรวจสลิป กันสลิปซ้ำ',
    desc: 'สลิปทุกใบถูกถอด QR ในรูปเพื่อจับเลขอ้างอิงธุรกรรม ใบเดิมที่ถูกแคปใหม่ก็จับได้ พร้อมคิวอนุมัติที่เทียบยอดกับออร์เดอร์ให้เห็นชัด — ระบบไม่มีการเช็คเงินเข้าบัญชีอัตโนมัติ ร้านค้าต้องเปิดแอปธนาคารตรวจสอบยอดเงินเข้าจริงเองก่อนกดอนุมัติทุกครั้ง',
  },
  {
    icon: 'box',
...
const FAQ = [
  ...
  {
    q: 'ระบบเช็คให้อัตโนมัติไหมว่าเงินเข้าจริง?',
    a: 'ไม่มีระบบเช็คเงินเข้าอัตโนมัติ — ระบบช่วยแค่คัดกรองสลิป (กันไฟล์ซ้ำ กันสลิปเดิมถูกแคปมาใช้ซ้ำ) เงินค่าสินค้าเข้าบัญชีพร้อมเพย์ของร้านโดยตรงเต็มจำนวนก็จริง แต่การยืนยันว่าเงินเข้าจริงหรือไม่ ร้านค้าต้องเปิดแอปธนาคารตรวจสอบเองทุกครั้งก่อนกดอนุมัติออร์เดอร์',
  },
];
